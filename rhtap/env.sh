...
export REKOR_HOST=https://rekor-server-rhtap-tas.apps.rosa.dx6f4-tonur-tc8.t4b0.p3.openshiftapps.com
export IGNORE_REKOR=false
export TUF_MIRROR=https://tuf-rhtap-tas.apps.rosa.dx6f4-tonur-tc8.t4b0.p3.openshiftapps.com
# Update forced CI test Thu Dec  5 10:14:15 EST 2024
